    ...
    [ // /* 00 */ Default State
      ...
      [ // /* 01 */ Play Button
        ...
        [ // /* 03 */ Button Events
          ...
          /* 00 */ 1, // state (0 = off, 1 = on)
          /* 01 */ function() { uiData[0][0][1][1][9] = 10; uiData[0][0][1][1][12] = 20; menuState = 1; }, // onHoverIn event (0 = no event)
          /* 02 */ function() { uiData[0][0][1][1][9] = 0; uiData[0][0][1][1][12] = 10; }, // onHoverOut event (0 = no event)
      ...
      [ // /* 02 */ Levels Button
        ...
        [ // /* 03 */ Button Events
          ...
          /* 00 */ 1, // state (0 = off, 1 = on)
          /* 01 */ function() { uiData[0][0][2][1][9] = 10; uiData[0][0][2][1][12] = 20; }, // onHoverIn event (0 = no event)
          /* 02 */ function() { uiData[0][0][2][1][9] = 0; uiData[0][0][2][1][12] = 10; }, // onHoverOut event (0 = no event)
      ...
      [ // /* 03 */ Settings Button
        ...
        [ // /* 03 */ Button Events
          ...
          /* 00 */ 1, // state (0 = off, 1 = on)
          /* 01 */ function() { uiData[0][0][3][1][9] = 10; uiData[0][0][3][1][12] = 20; }, // onHoverIn event (0 = no event)
          /* 02 */ function() { uiData[0][0][3][1][9] = 0; uiData[0][0][3][1][12] = 10; }, // onHoverOut event (0 = no event)
    ...
    [ // /* 00 */ Default State
      ...
      [ // /* 03 */ Reset Button
        ...
        [ // /* 03 */ Button Events
          ...
          /* 00 */ 1, // state (0 = off, 1 = on)
          /* 01 */ function() { uiData[2][0][3][1][9] = 10; uiData[2][0][3][1][12] = 20; }, // onHoverIn event (0 = no event)
          /* 02 */ function() { uiData[2][0][3][1][9] = 0; uiData[2][0][3][1][12] = 10; }, // onHoverOut event (0 = no event)
      ...
      [ // /* 04 */ Menu Button
        ...
        [ // /* 03 */ Button Events
          ...
          /* 00 */ 1, // state (0 = off, 1 = on)
          /* 01 */ function() { uiData[2][0][4][1][9] = 30; uiData[2][0][4][1][12] = 120; }, // onHoverIn event (0 = no event)
          /* 02 */ function() { uiData[2][0][4][1][9] = 0; uiData[2][0][4][1][12] = 60; }, // onHoverOut event (0 = no event)
          /* 03 */ function() { state = 0; } // onClick event (0 = no event)
        ]
      ]
    ],
