    ...
    [ // /* 00 */ Default State
      ...
      [ // /* 01 */ Level Buttons
        ...
        [ // /* 01 */ Box
          ...
          /* 07 */ 0.5, // v-align (0 = top, 0.5 = centre, 1 = bottom)
          /* 08 */ 255, // colour
          /* 09 */ function() { return 2 + (levelData[levelsWorld][((v * hNum) + h)][0] * 8) }, // alpha
        ...
        [ // /* 02 */ Text
          ...
          /* 02 */ 48, // text-size
          /* 03 */ 255, // text-colour
          /* 04 */ function() { return 25 + (levelData[levelsWorld][((v * hNum) + h)][0] * 175) }, // text-alpha
          /* 05 */ 0.5, // text-h-align
          /* 06 */ 0.5 // text-v-align
        ],
    ...
    [ // /* 00 */ Default State
      ...
      [ // /* 05 */ Shift Row/Column (Top Left)
        ...
        [ // /* 03 */ Button Events
          ...
          /* 02 */ 0, // onHoverOut event (0 = no event)
          /* 03 */ function() { if (steps > 0) { shiftTileLine(uiSelectedIndex, -1, -1, 1); } } // onClick event (0 = no event)
        ],
      ...
      [ // /* 06 */ Shift Row/Column (Top Right)
        ...
        [ // /* 03 */ Button Events
          ...
          /* 01 */ function() { return 10; }, // onHoverIn event (0 = no event)
          /* 02 */ 0, // onHoverOut event (0 = no event)
          /* 03 */ function() { if (steps > 0) { shiftTileLine(-1, uiSelectedIndex, -1, 1); } } // onClick event (0 = no event)
        ],
    ...
    [ // /* 02 */ Level Gen. UI
      ...
      [ // /* 00 */ Generate Level Button
        ...
        [ // /* 03 */ Button Events
          ...
          /* 00 */ 1, // state (0 = off, 1 = on)
          /* 01 */ function() { uiData[2][2][1][1][9] = 30; uiData[2][2][1][1][12] = 100; }, // onHoverIn event (0 = no event)
          /* 02 */ function() { uiData[2][2][1][1][9] = 0; uiData[2][2][1][1][12] = 50; }, // onHoverOut event (0 = no event)
      ...
      [ // /* 01 */ Reset Gen. Level Button
        ...
        [ // /* 03 */ Button Events
          ...
          /* 00 */ 1, // state (0 = off, 1 = on)
          /* 01 */ function() { uiData[2][2][2][1][9] = 30; uiData[2][2][2][1][12] = 100; }, // onHoverIn event (0 = no event)
          /* 02 */ function() { uiData[2][2][2][1][9] = 0; uiData[2][2][2][1][12] = 50; }, // onHoverOut event (0 = no event)
