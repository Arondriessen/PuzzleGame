    ...
    [ // /* 00 */ Default State
      ...
      [ // /* 03 */ Previous World Button
        ...
        [ // /* 03 */ Button Events
          ...
          /* 00 */ 1, // state (0 = off, 1 = on)
          /* 01 */ function() { if (uiHover2 != elementID) { animateUIElement([[uiData[1][0][3][1], 9], [uiData[1][0][3][1], 12]], [btFill, btStr], [(btFillHov / 2), btStrHov], btHovInSpd, 0); } menuState = 1; }, // onHoverIn event (0 = no event)
          /* 02 */ function() { animateUIElement([[uiData[1][0][3][1], 9], [uiData[1][0][3][1], 12]], [(btFillHov / 2), btStrHov], [btFill, btStr], btHovOutSpd, 0); }, // onHoverOut event (0 = no event)
      ...
      [ // /* 04 */ Next World Button
        ...
        [ // /* 03 */ Button Events
          ...
          /* 00 */ 1, // state (0 = off, 1 = on)
          /* 01 */ function() { if (uiHover2 != elementID) { animateUIElement([[uiData[1][0][4][1], 9], [uiData[1][0][4][1], 12]], [btFill, btStr], [(btFillHov / 2), btStrHov], btHovInSpd, 0); } menuState = 1; }, // onHoverIn event (0 = no event)
          /* 02 */ function() { animateUIElement([[uiData[1][0][4][1], 9], [uiData[1][0][4][1], 12]], [(btFillHov / 2), btStrHov], [btFill, btStr], btHovOutSpd, 0); }, // onHoverOut event (0 = no event)
      ...
      [ // /* 06 */ Current World Text
        ...
        [ // /* 01 */ Box
          ...
          /* 02 */ (width / 2) - (bgTileSize * uiScale), // x pos
          /* 03 */ (height / 2) - (bgTileSize * uiScale), // y pos
          /* 04 */ bgTileSize * 1.15 * uiScale, // width
          /* 05 */ bgTileSize * 1.07 * uiScale, // height
          /* 06 */ 0.5, // h-align (0 = left, 0.5 = centre, 1 = right)
          /* 07 */ 0.5, // v-align (0 = top, 0.5 = centre, 1 = bottom)
          /* 08 */ 0, // colour
          /* 09 */ 0, // alpha
      ...
      [ // /* 07 */ Current World Progress Text
        ...
        [ // /* 02 */ Text
          ...
          /* 00 */ 1, // state (0 = off, 1 = on)
          /* 01 */ function() { return ("( " + (unlockedLevel[levelsWorld - 1] - 1) + "   /   " + levelData[levelsWorld - 1].length + " )"); }, // text
          /* 02 */ 28 * uiScale, // text-size
          /* 03 */ 255, // text-colour
          /* 04 */ 190, // text-alpha
          /* 05 */ 1, // text-h-align
      ...
      [ // /* 08 */ Current World Progress Bar
        ...
        [ // /* 01 */ Box
          ...
          /* 02 */ (width / 2) - (bgTileSize * uiScale), // x pos
          /* 03 */ (height / 2), // y pos
          /* 04 */ function() { return (bgTileSize * 1.41 * ((unlockedLevel[levelsWorld - 1] - 1) / levelData[levelsWorld - 1].length) * uiScale); }, // width
    ...
    [ // /* 01 */ World 1 State
      ...
      [ // /* 01 */ Levels List.
        ...
        [ // /* 01 */ Box
          ...
          /* 02 */ width / 2, // x pos
          /* 03 */ height / 2, // y pos
          /* 04 */ levelBTSize * 1.34 * uiScale, // width
          /* 05 */ levelBTSize * 1.34 * uiScale, // height
          /* 06 */ 0.5, // h-align (0 = left, 0.5 = centre, 1 = right)
          /* 07 */ 0.5, // v-align (0 = top, 0.5 = centre, 1 = bottom)
          /* 08 */ 0, // colour
          ...
          /* 17 */ function() { return 3; }, // v-number (min, dynamically adjusted)
          /* 18 */ function() { return levelBTOffset * 1.34 * uiScale; }, // x-offset
          /* 19 */ function() { return levelBTOffset * 1.34 * uiScale; }, // y-offset
          /* 20 */ function() { return -levelBTOffset * 1.34 * uiScale; }, // x-offset (new line)
          /* 21 */ function() { return levelBTOffset * 1.34 * uiScale; } // y-offset (new line)
        ],
    ...
    [ // /* 02 */ World 2 State
      ...
      [ // /* 01 */ Levels List.
        ...
        [ // /* 04 */ Image
          ...
          /* 00 */ function() { return !levelData[1][((v * hNum) + h)][0]; }, // state (0 = off, 1 = on)
          /* 01 */ function() { return lockedIcon; }, // image
          /* 02 */ (levelBTSize - 36) * uiScale, // image-size
          /* 03 */ 0, // image-alpha
          /* 04 */ 0.5, // image-h-align
          /* 05 */ 0.5, // image-v-align
        ]
    ...
    [ // /* 00 */ Default State
      ...
      [ // /* 03 */ Reset Button
        ...
        [ // /* 04 */ Image
          ...
          /* 00 */ 1, // state (0 = off, 1 = on)
          /* 01 */ function() { return resetIcon; }, // image
          /* 02 */ 44 * uiScale, // image-size
          /* 03 */ 255, // image-alpha
          /* 04 */ 0.5, // image-h-align
          /* 05 */ 0.5, // image-v-align
        ]
      ...
      [ // /* 08 */ Active Mechanics Used in Level
        ...
        [ // /* 01 */ Box
          ...
          /* 00 */ 1, // state (0 = off, 1 = on)
          /* 01 */ 1, // type (1 = rect, 2 = rounded rect, 3 = circle)
          /* 02 */ function() { return ((width / 2) - (bgTileSize * uiScale * 2) + (136 * uiScale)); }, // x pos
          /* 03 */ function() { return ((height / 2) - (bgTileSize * uiScale) + (96 * uiScale)); }, // y pos
        ...
        [ // /* 04 */ Image
          ...
          /* 00 */ 0, // state (0 = off, 1 = on)
          /* 01 */ function() { if (levelData[world - 1][level - 1][5][(v * hNum) + h]) { return gameMechanicIcons[(v * hNum) + h]; } else { return xCircle } }, // image
    ...
    [ // /* 05 */ Pre-Game Info Screen
      ...
      [ // /* 04 */ Active Mechanics Used in Level
        ...
        [ // /* 02 */ Text
          ...
          /* 03 */ 255, // text-colour
          /* 04 */ function() { return (30 + (levelData[world - 1][level - 1][5][(v * hNum) + h] * 120)); }, // text-alpha
          /* 05 */ 0, // text-h-align
          /* 06 */ 0.5 // text-v-align
        ],
        ...
        [ // /* 04 */ Image
          ...
          /* 00 */ 1, // state (0 = off, 1 = on)
          /* 01 */ function() { if (levelData[world - 1][level - 1][5][(v * hNum) + h]) { return gameMechanicIcons[(v * hNum) + h]; } else { return xCircle } }, // image
          /* 02 */ function() { if (levelData[world - 1][level - 1][5][(v * hNum) + h]) { return 56 * uiScale; } else { return 24 * uiScale } }, // image-size
          /* 03 */ 0, // image-alpha
          /* 04 */ 1, // image-h-align
          /* 05 */ 0.5, // image-v-align
        ]
